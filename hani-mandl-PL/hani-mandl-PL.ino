...
// Allgemeine Variablen
        ...
        int buzzermode = 1;             // 0 = aus, 1 = ein. TODO: Tastentöne als buzzermode 2?
...
// Parameter aus den Preferences für den Rotary Encoder setzen
        ...
        u8g2.setCursor(0, 10);    u8g2.print("Pomysl: M. Vasterling");
        u8g2.setCursor(0, 23);    u8g2.print("Kode: M. Vasterling, M.");
